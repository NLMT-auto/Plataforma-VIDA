...
#include "vida_interfaces/msg/detail/controls__rosidl_typesupport_fastrtps_c.h"
...
using _Controls__ros_msg_type = vida_interfaces__msg__Controls;
...
size_t get_serialized_size_vida_interfaces__msg__Controls(
  const void * untyped_ros_message,
...
static uint32_t _Controls__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vida_interfaces__msg__Controls(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vida_interfaces
size_t max_serialized_size_vida_interfaces__msg__Controls(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vida_interfaces__msg__Controls;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Controls__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vida_interfaces__msg__Controls(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vida_interfaces, msg, Controls)() {
