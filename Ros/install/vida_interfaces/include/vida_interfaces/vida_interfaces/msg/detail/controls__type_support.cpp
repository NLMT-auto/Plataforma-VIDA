...
{
  new (message_memory) vida_interfaces::msg::Controls(_init);
}

void Controls_fini_function(void * message_memory)
{
  auto typed_message = static_cast<vida_interfaces::msg::Controls *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Controls_message_member_array[2] = {
  {
    ...
    offsetof(vida_interfaces::msg::Controls, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(vida_interfaces::msg::Controls, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Controls_message_members = {
  ...
  2,  // number of fields
  sizeof(vida_interfaces::msg::Controls),
...
{
  return &::vida_interfaces::msg::rosidl_typesupport_introspection_cpp::Controls_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vida_interfaces, msg, Controls)() {
  return &::vida_interfaces::msg::rosidl_typesupport_introspection_cpp::Controls_message_type_support_handle;
}
